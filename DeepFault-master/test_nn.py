...
def test_model(model, X_test, Y_test):   # 将正确的错误的输出区分开来
    """
    ...
    layer_outs = get_layer_outs(model, X_test)  # https://stackoverflow.com/questions/41711190/keras-how-to-get-the-output-of-each-layer
    ...
    expectations = np.argmax(Y_test, axis=1) # horizontal direction
